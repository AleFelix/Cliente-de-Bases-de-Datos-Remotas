...
public class VistaCliente {
	...
	public boolean chequearQuery(String sql) {
		...
		if (tipo.equals("select") || tipo.equals("insert") || tipo.equals("update") || tipo.equals("delete"))
			resultado = true;
		return resultado;
	}
	...
	public void mostrarRespuesta(List<String> respuesta) {
		if (respuesta == null)
			...
			System.out.println("DEBUG: Tamaño de respuesta:" + respuesta.size());
			System.out.println("DEBUG: NºColumnas:"+cantColumnas+" NºFilas:"+cantFilas);
