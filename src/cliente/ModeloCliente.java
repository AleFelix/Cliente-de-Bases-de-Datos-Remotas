...
public class ModeloCliente {
	...
	public void enviarConsulta(String db, String query) {
		...
		try {
			...
			DataInputStream ois = new DataInputStream(socketConServidor.getInputStream());
			DataOutputStream oos = new DataOutputStream(socketConServidor.getOutputStream());
			...
			if (QueryManager.chequearError(respuestaJSON))
				...
				respuestaEnLista = QueryManager.decodificarRespuesta(respuestaJSON);
